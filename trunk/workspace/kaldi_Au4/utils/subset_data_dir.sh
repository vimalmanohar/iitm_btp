...
function do_filtering {
  ...
  [ -f $srcdir/mfc.scp ] && utils/filter_scp.pl $destdir/utt2spk <$srcdir/mfc.scp >$destdir/mfc.scp
  ...
  if [ -f $srcdir/segments ]; then
     ...
     [ -f $srcdir/mfc.scp ] && utils/filter_scp.pl $destdir/reco <$srcdir/mfc.scp >$destdir/mfc.scp
