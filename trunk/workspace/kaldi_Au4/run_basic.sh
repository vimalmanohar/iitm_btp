...
MAIN_DIR=/speech/vimal/workspace/kaldi_au4
TEMP_DIR=/speech/vimal/scratch/kaldi_au4

DATA_DIR=$TEMP_DIR/data
data=$PATH_BASE/data_htk

au4=/speech/vimal/Database/aurora4/speech_data_aurora4
wsj0=/speech/vimal/Database/WSJ284/WSJ0-84
...
monoName=mono.vimal.htk1.$train_cond 
tri1Name=tri1.vimal.htk1.$initGaussians.$finalGaussians.$train_cond
triDeltasName=tri2a.vimal.htk1.$initGaussiansDeltas.$finalGaussiansDeltas.$train_cond
...
if [ $prepareLangFlag == 1 ]; then
    ...
    sh -x local/au4_prepare_dict.sh --data-dir $data || exit 1;
