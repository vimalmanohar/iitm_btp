...
beam=15.0
gselect=
full_gselect=  # Number of Gaussian-selection indices for SGMMs.  [Note:
...
if [ $full_gselect == "" && $gselect == "" ]; then
  full_gselect=15
else if [ $full_gselect == "" ];
  full_gselect=$gselect
fi
...
if [ $stage -le 1 ]; then
  $cmd JOB=1:$nj $dir/log/gselect.JOB.log \
    sgmm-gselect --full-gmm-nbest=$full_gselect $srcdir/final.mdl \
